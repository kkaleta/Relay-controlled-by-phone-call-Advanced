...
// pins definition
#define GSM_ON              2// connect GSM Module turn ON to pin 77 
...
// length for the internal communication buffer //org 200!
#define COMM_BUF_LEN        160
...
public:
	 ...
	 void RTCtime(int *day,int *month, int *year,int *hour,int *minute, int *second);
	  char getBattInf(char *st,char *str_perc, char *str_vol);
	 //
...
public:
     ...
     char WritePhoneNumber(byte position, char *phone_number, char *name_str);
